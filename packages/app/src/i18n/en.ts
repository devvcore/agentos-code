...
export const dict = {
  "omni.live.type": "Type a message",
  "omni.live.message": "Message your coding agent…",
  "omni.live.sendFailed": "Could not send your message. Your text is still here; try again.",
  "omni.live.transcript": "Voice",
  "omni.live.transcriptEmpty": "Your conversation will appear here.",
  "omni.live.you": "You",
  "omni.live.omni": "Omni",
  "omni.live.holdSpace": "Mic muted · Hold Space to talk",
  "omni.live.start": "Start GPT Live conversation",
  "omni.live.end": "End call",
  "omni.live.connected": "GPT Live",
  "omni.live.requesting": "Allow microphone…",
  "omni.live.connecting": "Connecting GPT Live…",
  "omni.live.ending": "Ending call…",
  "omni.live.mute": "Mute mic",
  "omni.live.unmute": "Unmute mic",
  "omni.live.silence": "Mute speaker",
  "omni.live.speaker": "Unmute speaker",
  "omni.live.play": "Enable audio",
  "omni.live.denied": "Allow microphone access in System Settings to start a live conversation.",
  "omni.live.failed": "Live voice could not connect or was interrupted. Your coding work remains in chat. Try again.",
  "omni.live.auth": "Your AgentOS sign-in has expired. Sign in again to use live voice.",
  "omni.live.credits": "Your AgentOS workspace is out of credits. Open your account to add credits.",
  "omni.live.conflict": "End your current AgentOS call before starting another.",
  "omni.mode.label": "Mode",
  "omni.mode.code": "Code",
  "omni.mode.work": "Work",
  "omni.voice.start": "Dictate a prompt",
  "omni.voice.stop": "Finish dictation",
  "omni.voice.cancel": "Cancel dictation",
  "omni.work.panel": "Work",
  "omni.work.progress.title": "Progress",
  "omni.work.progress.count": "{{done}} of {{total}} done",
  "omni.work.progress.empty": "Omniwork will lay out its plan here as it works.",
  "omni.work.outputs.title": "Outputs",
  "omni.work.outputs.empty": "Finished files will appear here.",
  "omni.work.outputs.open": "Open {{name}}",
  "omni.work.outputs.openFailed": "Could not open file",
  "omni.work.outputs.missing": "This file no longer exists.",
  "omni.work.folder.title": "Folder",
  "omni.work.folder.open": "Open folder",
  "omni.work.outputs.preview": "Preview {{name}}",
  "omni.work.preview.label": "File preview",
  "omni.work.preview.close": "Close preview",
  "omni.work.preview.openDefault": "Open in default app",
  "omni.work.preview.openIn": "Open in {{app}}",
  "omni.work.preview.loading": "Loading preview…",
  "omni.work.preview.failed": "Couldn't load this file.",
  "omni.work.preview.renderFailed": "Couldn't display this file.",
  "omni.work.preview.outside": "Only files inside the working folder can be previewed.",
  "omni.work.preview.tooLarge.title": "This file is too large to preview",
  "omni.work.preview.tooLarge.description": "Files up to {{size}} MB can be previewed here.",
  "omni.work.preview.unsupported.title": "Preview not available yet",
  "omni.work.preview.unsupported.description": "Open it in {{app}} to see its contents.",
  "omni.work.preview.unsupported.descriptionDefault": "Open it in its default app to see its contents.",
  "omni.work.preview.unsupported.descriptionWeb": "This file type can't be shown here yet.",
  "omni.work.preview.page": "Page {{current}} of {{total}}",
  "omni.work.preview.sheets": "Sheets",
  "omni.work.preview.truncated": "Showing the first {{rows}} rows and {{columns}} columns.",
  ...
  "agentos.server.local":
    "AgentOS Code runs on this computer and uses your AgentOS account for models and workspace credits.",
