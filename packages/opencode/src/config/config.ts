    ...
    const loadInstanceState = Effect.fn("Config.loadInstanceState")(
      function* (ctx: InstanceContext) {
        ...
        for (const dir of directories) {
          ...
          // OmniCode versions are never published as @opencode-ai/plugin and it runs without external plugins,
          // so this install could only fail, after a registry round trip, on every start.
