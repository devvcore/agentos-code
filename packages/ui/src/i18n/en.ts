export const dict: Record<string, string> = {
  ...
  "ui.tool.shell": "Shell",
  "ui.tool.patch": "Patch",
  "ui.tool.work.created": "Created {{file}}",
  "ui.tool.work.creating": "Creating {{file}}",
  "ui.tool.work.updated": "Updated {{file}}",
  "ui.tool.work.updating": "Updating {{file}}",
  "ui.tool.work.deleted": "Deleted {{file}}",
  "ui.tool.work.deleting": "Deleting {{file}}",
  "ui.tool.work.saved": "Saved {{file}}",
  "ui.tool.work.saving": "Saving {{file}}",
  "ui.tool.work.shared": "Shared {{file}}",
  "ui.tool.work.updatedFiles": "Updated files",
  "ui.tool.work.updatingFiles": "Updating files",
  "ui.tool.work.kind.create": "Created",
  "ui.tool.work.kind.update": "Updated",
  "ui.tool.work.kind.delete": "Deleted",
  "ui.tool.work.kind.write": "Saved",
  "ui.tool.work.kind.share": "Shared",
  "ui.tool.work.kind.pending": "Writing…",
  "ui.tool.work.status.working": "Working…",
  "ui.tool.work.status.reading": "Reading {{target}}",
  "ui.tool.work.status.readingFiles": "Looking through files",
  "ui.tool.work.status.running": "Running analysis",
  "ui.tool.work.status.researching": "Researching",
  "ui.tool.work.status.planning": "Planning",
  "ui.tool.work.status.loading": "Loading {{target}} guide",
  "ui.tool.work.status.loadingGuide": "Loading guide",
  "ui.tool.work.status.writing": "Writing {{target}}",
  "ui.tool.work.status.writingFiles": "Writing files",
  "ui.tool.work.status.opening": "Opening {{target}}",
  "ui.tool.work.status.openingFiles": "Opening files",
  ...
  "ui.markdown.chart.label": "Chart",
  "ui.markdown.chart.loading": "Drawing chart…",
  "ui.markdown.chart.error": "Couldn't draw this chart",
  "ui.markdown.chart.source": "Show chart data",
  "ui.markdown.chart.category": "Category",
